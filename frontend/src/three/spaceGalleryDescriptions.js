...
export const spaceGalleryModels = [
  {
    ...
    type: 'model',
    docentContext: docentContext('solar-system'),
  },
  {
    id: 'space-shuttle',
    title: '우주왕복선',
    ...
    type: 'model',
    docentContext: docentContext('space-shuttle'),
  },
  {
    id: 'astronaut',
    title: 'NASA EVA 우주복',
    ...
    type: 'model',
    docentContext: docentContext('astronaut'),
  },
  {
    id: 'gemini-spacesuit',
    title: '제미니 우주복',
    ...
    type: 'model',
    docentContext: docentContext('gemini-spacesuit'),
  },
  {
    id: 'mars-rover',
    title: '화성 탐사 로버',
    ...
    type: 'model',
    docentContext: docentContext('mars-rover'),
  },
  {
    id: 'rocket',
    title: '새턴 V 로켓',
    ...
    type: 'model',
    docentContext: docentContext('rocket'),
  },

  {
    ...
    type: 'model',
    docentContext: docentContext('satellite'),
  },
  {
    id: 'ufo',
    title: '미확인 비행체 (UFO)',
    ...
    type: 'model',
    docentContext: docentContext('ufo'),
  },
  {
    id: 'black-hole',
    title: '블랙홀',
    ...
    type: 'model',
    docentContext: docentContext('black-hole'),
  },
];
